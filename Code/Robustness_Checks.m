...
Inf_Cities(26:end,:) = Inf_Cities(26:end,:)*0.75;
...
for n = 1:8
    [Base_Model_robust_25(n)] = est_parms_bpareto(Inf_Cities(26:end,n+1),dmax_Cities(n),dmin_Cities(n), citynames(n));
end
...
for n=1:8
    hold on
    plot(years(26:end), (bpareto_outbreakprob(Base_Model(n).alpha',Base_Model(n).dmax,Base_Model(n).dmin,500)-bpareto_outbreakprob(Base_Model_robust_75(n).alpha',Base_Model_robust_75(n).dmax,Base_Model_robust_75(n).dmin,500)), Linemarkertypes{n} , 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
end
hold on
ylabel({'Overestimation',sprintf('Prob(>500 deaths/million)')},'fontsize',8)
xlim([1919,1956])
xticks([1920:5:1956])
...
for n=1:8
    hold on
    plot(years(26:end), (bpareto_outbreakprob(Base_Model(n).alpha',Base_Model(n).dmax,Base_Model(n).dmin,1000)-bpareto_outbreakprob(Base_Model_robust_25(n).alpha',Base_Model_robust_25(n).dmax,Base_Model_robust_25(n).dmin,1000)), Linemarkertypes{n} , 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
end
hold on
ylabel({'Overestimation',sprintf('Prob(>1,000 deaths/million)')},'fontsize',8)
...
for n=1:8
    hold on
    plot(years(26:end), (bpareto_outbreakprob(Base_Model(n).alpha',Base_Model(n).dmax,Base_Model(n).dmin,500)-bpareto_outbreakprob(Base_Model_robust_50(n).alpha',Base_Model_robust_50(n).dmax,Base_Model_robust_50(n).dmin,500)), Linemarkertypes{n} , 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
end
hold on
ylabel({'Overestimation',sprintf('Prob(>500 deaths/million)')},'fontsize',8)
xlim([1919,1956])
...
for n=1:8
    hold on
    plot(years(26:end), (bpareto_outbreakprob(Base_Model(n).alpha',Base_Model(n).dmax,Base_Model(n).dmin,1000)-bpareto_outbreakprob(Base_Model_robust_50(n).alpha',Base_Model_robust_50(n).dmax,Base_Model_robust_50(n).dmin,1000)), Linemarkertypes{n} , 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
end
hold on
ylabel({'Overestimation',sprintf('Prob(>1,000 deaths/million)')},'fontsize',8)
