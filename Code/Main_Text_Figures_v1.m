...
for n=1:10
   ...
   outbreakrisk_500(n,:)=bpareto_outbreakprob(Base_Model(i).alpha',Base_Model(i).dmax,Base_Model(i).dmin,500);
    ...
    slope_500(:,1) = -(outbreakrisk_500(:,10) - outbreakrisk_500(:,1))./outbreakrisk_500(:,1)*100;
...
%     ylim([0,0.3])
    ...
    hold on
    for i=1:10
        plot(average_infant_mort(i),slope_500(i,1),Markertypes{i}, 'Color','black', 'Markersize',6 );
    end
    xlabel({'Infant Mortality pre-1918 (deaths/1,000 births)'})
