...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    figure(13)
       pa = subplot(2,2,1)
        ...
        plot(Influenza_EW(55:80,1), weibull_outbreakprob(Weibull_Model(11).w',Base_Model(11).dmax/3*2/10),'-o', 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
        hold on 
        plot(Influenza_EW(55:80,1), weibull_outbreakprob(Weibull_Model(11).w',Base_Model(11).dmax/2/10),'-*', 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
        plot(Influenza_EW(55:80,1), weibull_outbreakprob(Weibull_Model(11).w',Base_Model(11).dmax/3/10),'-x', 'Linewidth', 0.5, 'Markersize', 4 , 'Color', 'black')
